...
pubDate: 2026-01-08
tags: ["AI", "AI Tools", "Legal Writing", "Legal Research"]
published: true
---
...
## QUESTION PRESENTED: 
Does my work suffer from using AI to write for me?

## SHORT ANSWER: 
Yes. Using AI to write is now being shown to lead to converging results. We all end up with similar structure and arguments. So what is the point of writing arguments for a living if you leave the argument for someone else.
...
The internet is full of blog posts espousing the power of using Large Language Models like ChatGPT as creative collaborators. Of course, AI can and effectively does produce first drafts for use in the editing process. But what happens when we use AI as a colloaborator? Do we get better ideas? Or do we converge on the same basic ideas and output?

#### AI Model Convergance
(person who published this) published an interesting case study that implicates this idea. The study used a wide range of available LLMs and asked them open-ended questioons designed to illicit varying responses. 
